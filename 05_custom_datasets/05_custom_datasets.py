...
pprint(f"all image paths: {image_path_list}")

# 2. Get random image path
random_image_path = random.choice(image_path_list)
pprint(f"get random image path: {image_path_list}")
...
class ImageFolderCustom(Dataset):
    ...
    def __getitem__(self, index: int) -> Tuple[torch.Tensor, int]:
        ...
        class_name = self.paths[
            index
        ].parent.name  # expects path in data_folder/class_name/image.jpg
...
print(f"train_dataloader_custom: {train_dataloader_custom}")
print(f"test_dataloader_custom: {test_dataloader_custom}")
...
plot_transformed_images(
    image_paths=image_path_list, transform=train_transforms, n=3, seed=None
)
plt.show()
...
print(f"train_dataloader_simple: {train_dataloader_simple}")
print(f"test_dataloader_simple: {test_dataloader_simple}")
print("-" * 100)
...
print(f"test_data_simple: {test_data_simple}")
print("-" * 100)
...
print(f"train_dataloader_augmented: {train_dataloader_augmented}")
print(f"test_dataloader: {test_dataloader}")
print("-" * 100)
